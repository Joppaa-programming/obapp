...
//console.log(mainArry)
    ...
    return (
        <div className="h-[3vh] w-full pt-4 mt-4 px-6"><h1 className='text-3xl text-left leading-none tracking-tighter font-bold'>Originally.Black</h1> 
        
        {/* <div onClick={(e)=>handleClick(e)} className='w-full pt-[1.5rem] flex font-semibold relative shadow-md justify-between p-2 flex-row'>
