...
export default function InfoTab({src,alt,title,infor}) {
    return <div className=" relative flex flex-col items-center justify-center flex-shrink-0 px-4 rounded-sm ">
      <Image
        src={src}
        alt={alt}
        width={300}
      ...
      <span className='absolute bottom-20 rounded-sm bg-slate-50'>
