      ...
      {data ? data.map((gridItem) => {
        return (
          <>
            ...
            <div key={gridItem.id} onClick={() => router.push(`/origin/${gridItem.id}`)} className={`  ${gridItem.isAd ? 'col-span-3  row-span-3 sm:col-span-2  sm:row-span-2' : gridItem.isPortrait ? 'col-span-1 row-span-2 ' : ' col-span-1 row-span-1  '}`}>
