  ...
  return (
    <div className="landing-page mb-14">
      <section className="hero h-screen bg-primary-dark flex flex-col relative items-center justify-center">
        ...
        <span className='absolute top-1/2 flex flex-col p-5'>
      ...
      <section className=" h-screen flex flex-col pt-8 pb-8 mb-18 items-center justify-evenly">
        ...
        <div className=" flex items-center mt-2 flex-row overflow-x-auto overflow-y-hidden sm:overflow-x-scroll  no-scrollbar ">
          <InfoTab src={"/lady-min.jpg"} alt={"A bowl of delicious soul food"} title={"Discover Hidden Gems"} infor={"Find authentic cuisine, unique fashion, and more."} />
        ...
        <div className="flex flex-col gap-1 pt-3 mt-3 items-center justify-center">
          <h2 className=' text-center px-10'>{`Are you an Entreprenuer? Showcase Your Excellence`}</h2>
          <Link className='cursor-pointer  hover:text-purple-500' href="https://business.originally.black">
            <button className="button underline underline-offset-2">Join Originally.Black</button>
          </Link>
        </div>
      </section>
