...
export interface HubspotFormProps {
     ...
     */
    readonly onFormSubmit?: ($form?: HTMLFormElement, formValues?: {
        name: string;
        value: any;
    }[]) => any;
    /**
     ...
     */
    readonly onFormSubmitted?: (submitMessage: HTMLDivElement, params: {
        redirectUrl: string;
    }) => any;
    ...
    readonly onFormError?: (errorCode: string, _: unknown, values: {
        id: string;
        value: any;
        errors: string[][];
    }[]) => any;
